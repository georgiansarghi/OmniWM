...
| `position` | string | `"overlappingMenuBar"` | `overlappingMenuBar`, `belowMenuBar`, `bottom`, `left`, or `right`. **Unreleased:** bottom and side placements follow the usable display edge, avoiding a visible Dock. |
